...
// VScrollBarWidth the width of vscrollbar in pixels
const VScrollBarWidth = 16

// VScrollBar handles vertical viewport scrolling
...
// ContentOffset returns inner content offset
func (v *VScrollBar) ContentOffset() int {
	return v.contentOffset
}

// Update updates vscrollbar logical state
...
// Draw updates vscrollbar graphical state
